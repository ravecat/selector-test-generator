...
LIST_MR_GITHUB=`curl --silent "https://api.github.com/search/issues?q=head:${CI_COMMIT_REF_NAME}+repo:${CI_PROJECT_NAME}/${GITHUB_OWNER}" --header "Accept: application/vnd.github.v3+json"`;
